...
"#,
    ...
    fn github_pr_url_detection_is_specific() {
        assert!(looks_like_github_pr_url(
            "https://github.com/example-org/example-repo/pull/2922"
        ));
        assert!(!looks_like_github_pr_url(
            "https://github.com/example-org/example-repo/issues/2922"
        ));
    }
    ...
    fn pr_feedback_query_detection_matches_check_and_comments() {
        assert!(looks_like_pr_feedback_query(
            "check https://github.com/example-org/example-repo/pull/2922"
        ));
        assert!(looks_like_pr_feedback_query(
            "see https://github.com/example-org/example-repo/pull/2922 for comments"
        ));
        assert!(!looks_like_pr_feedback_query(
            "open https://github.com/example-org/example-repo/pull/2922 in browser"
        ));
    }
