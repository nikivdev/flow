...
fn parse_pr_opts(opts: &PrOpts) -> ParsedPrArgs {
    let first = opts
        .mode_or_title
        .as_deref()
        .map(|s| s.trim())
    ...
    let preview = first == Some("preview");
...
mod tests {
    ...
    fn test_parse_pr_args() {
        ...
        let p = parse_pr_opts(&PrOpts {
            mode_or_title: Some("preview".into()),
            title_rest: vec![],
            base: "main".into(),
            draft: false,
            branch: None,
        ...
        let p = parse_pr_opts(&PrOpts {
            mode_or_title: Some("preview".into()),
            title_rest: vec!["hello world".into()],
            base: "main".into(),
            draft: false,
            branch: None,
            no_open: true,
        ...
        let p = parse_pr_opts(&PrOpts {
            mode_or_title: Some("preview".into()),
            title_rest: vec!["reduce".into(), "latency".into()],
            base: "main".into(),
            draft: false,
            branch: None,
            no_open: true,
        ...
        let p = parse_pr_opts(&PrOpts {
            mode_or_title: Some("reduce".into()),
            title_rest: vec!["latency".into()],
            base: "main".into(),
            draft: false,
            branch: None,
            no_open: true,
